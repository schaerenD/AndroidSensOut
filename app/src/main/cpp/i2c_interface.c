...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_i2c_I2C_open(JNIEnv *env, jobject obj, jstring file)
{
#ifndef EMULATOR
    ...
    /* Get device file name from the java environment */
    str = (const char*) (*env)->GetStringUTFChars(env, file, NULL);
    if (str == NULL)
    {
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_i2c_I2C_SetSlaveAddress(JNIEnv *env, jobject obj, jint file, jint slaveAddr)
{
#ifndef EMULATOR
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_i2c_I2C_read(JNIEnv * env, jobject obj, jint fileHander, jintArray bufArray, jint len)

{
    ...
    /* Copy a region of a primitive array into a the buffer */
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_i2c_I2C_write(JNIEnv *env, jobject obj, jint fileHander, jintArray inJNIArray, jint len)
{
#ifndef EMULATOR
...
JNIEXPORT void JNICALL Java_ch_bfh_ti_i2c_I2C_close(JNIEnv *env, jobject obj, jint fileHander)
{
#ifndef EMULATOR
    close(fileHander);
#endif
